    ...
    if (args === "me" || args === "stats") {
      ...
      await respond({
        ...
        text: [
          ...
          "",
          "*Points:*",
          "• *Giving* a tracked reaction: 1 point (per message)",
          "• *Receiving* a tracked reaction: 2 points (per message)",
          "",
          "*⭐ Star Bonus:*",
          "Add :star: to your message to increase point value!",
          "1-5 stars = +1-5 bonus points for both giver and receiver.",
          "",
